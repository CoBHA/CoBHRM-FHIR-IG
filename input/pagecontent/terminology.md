...
{% include codesystem-list.xhtml %} <!-- Just those code systems defined in this IG -->

<!-- {% include codesystem-ref-list.xhtml %}  also those code systems referenced in this IGs -->

<!-- {% include codesystem-ref-all-list.xhtml %}  also those code systems referenced in core and dependency IGs -->

### Value Sets used by this IG

<!-- {% include valueset-list.xhtml %}  Just those VS defined in this IG -->
